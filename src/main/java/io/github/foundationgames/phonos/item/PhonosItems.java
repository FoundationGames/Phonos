...
public class PhonosItems {
    ...
    public static final Item PORTABLE_SPEAKER = register(new PortableSpeakerItem(new Item.Settings().group(Phonos.PHONOS_ITEM_GROUP).maxCount(1)), "portable_speaker");
    ...
    public static void init() {
        ServerPlayConnectionEvents.DISCONNECT.register(PortableSpeakerItem::onPlayDisconnect);
    }
}
